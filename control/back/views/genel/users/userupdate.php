<div class="row">
	<div class="col-sm-12">
		<h4 class="page-title">Üye Düzenle</h4>
		<ol class="breadcrumb">
			<li><a href="<?=URL;?>/control">Ana Ekran</a></li>
			<li class="active">Üye Düzenle / <?=$this->user_info["login"];?></li>
		</ol>
	</div>
</div>
<div class="row">
	<div class="col-sm-12">
		<div class="card-box">
			<h4 class="m-t-0 header-title m-b-30"><b>Üye Düzenle</b></h4>
			<div class="row">
				<div class="container">
					<div class="col-md-8 col-md-offset-2">
						<form action="<?=URL;?>/control/users/userupdatesave/<?=$this->user_info["id"];?>" method="post" enctype="multipart/form-data" name="add_user" class="form-horizontal" id="add_user" role="form">
							...
							<div class="form-group">
								...
								<div class="col-md-10">
									<select class="form-control" name="yetki" id="yetki">
										...
										<option value="<?=$value["id"];?>" <?php if($this->user_info["role"] == $value["id"]){echo 'selected';} ?>><?=$value["title"];?></option>
										<?php } ?>
									</select>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-md-10">
									<?php if($this->user_info["avatar"] != default_avatar){ ?>
										<img src="<?=URL;?>/public/images/uploads/<?=$this->user_info["avatar"];?>" class="img-thumbnail thumb-lg" />
									<?php }else{ ?>
										<img src="<?=URL;?>/public/images/<?=$this->user_info["avatar"];?>" class="img-thumbnail thumb-lg" />
									<?php } ?>
								</div>
							</div>
							<div class="form-group">

		...
		<div class="row">
			<div class="col-lg-3 col-md-3">
				<aside class="widget widget-recent">
					<h3 class="sidebar-title">Kin'den Duyurular</h3>
					<ul>
						<?php
						foreach($data["home"] as $x => $home){
						$fotopath = upload_img("kategoriler/216/".$home["resim"]);
						?>
						<li>
				...
				<article class="blog-post-wrapper">
					<div class="post-information">
						...
						<div class="post-thumbnail">
							<img src="<?=upload_img("kategoriler/216/".$data["content"]["resim"]);?>" title="<?=$data["content"]["baslik"];?>" />
						</div>
